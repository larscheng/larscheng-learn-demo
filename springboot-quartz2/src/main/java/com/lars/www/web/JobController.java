...
import com.lars.www.service.JobAndTriggerImpl;
import org.quartz.*;
...
{
	@Autowired
	private JobAndTriggerImpl iJobAndTriggerService;
	...
	{		
		...
		System.out.println(scheduler.deleteJob(JobKey.jobKey(jobClassName, jobGroupName)));
	}
